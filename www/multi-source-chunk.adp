           ...
           <div class="na-item-button-bar">
            <if @write_p@ true>
             <if @items.save_url@ not nil>
               <a href="@items.save_url@" alt="Mark this item as saved" class="button">#news-aggregator.Save#</a>
             </if>
             <if @items.unsave_url@ not nil>
              <a href="@items.unsave_url@" alt="Unmark this item as saved" class="button">#news-aggregator.Unsave#</a>
             </if>
            </if>
            <if @blog_p@ true>
             <a href="@items.item_blog_url@" alt="Post this item to a Weblog" class="button">#news-aggregator.Blog#</a>
            </if>
           </div>
          </div>
        </if>
